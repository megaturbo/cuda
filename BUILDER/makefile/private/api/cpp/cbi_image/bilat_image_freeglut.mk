...
override API_INC+= ${BILAT_IMAGE_FREEGLUT_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_FREEGLUT_PATH}/,${BILAT_IMAGE_FREEGLUT_INC})

#Linkage
#Use SrcAux car nom lib complexe!
override SRC_AUX+= ${BILAT_IMAGE_FREEGLUT_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_FREEGLUT_PATH}/,${BILAT_IMAGE_FREEGLUT_LIB})  

#Runtime
override API_BIN+= ${BILAT_IMAGE_FREEGLUT_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_FREEGLUT_PATH}/,${BILAT_IMAGE_FREEGLUT_BIN})
